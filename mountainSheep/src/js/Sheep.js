export class Sheep {
    constructor(img, stageWidth) {
        ...
        this.fps = 24;
        this.fpsTime = 1000 / this.fps;  // timestamp와의 비교값
    }
    ...
    draw(ctx, t, dots) {
        ...
        if (now > this.fpsTime) {    // fps 설정
            this.time = t;
            this.curFrame += 1;      // 양 움직이도록 함(8프레임)
    ...
    getPointOnQuad(x1, y1, x2, y2, x3, y3, t) {
        ...
        const rotation = -Math.atan2(tx, ty) + (90 * Math.PI / 180);  // 양의 방향 rotation
        return {
